...
const tweet = {
  ...
  user: {
    ...
    name: 'Elon Musk',
    username: 'elonmusk',
    profile_image_url: 'https://pbs.twimg.com/profile_images/1529956155937759233/Nyn1HZWF_400x400.jpg',
  },
  comments: [
    {
      id: 1,
      ...
      user: {
        ...
        profile_image_url: 'https://pbs.twimg.com/profile_images/1510983419588919296/bvtUUkHo_400x400.jpg',
      },
    ...
    },
    {
      ...
      user: {
        ...
        profile_image_url: 'https://i.insider.com/61cc84b94710b10019c77960?width=500&format=jpeg&auto=webp',
      }, //
  ...
  retweet_count: 4380,
  has_liked: false,
  media_urls: ['https://pbs.twimg.com/media/FZdKy4gXoAE9IVY?format=jpg&name=large',
...
const TweetCard = () => (
  <div className={styles.container}>
    <div className={styles.avatarContainer}>
      <img src={tweet.user.profile_image_url} alt="avatar" className={styles.avatar} />
    </div>
    <div className={styles.contentContainer}>
      ...
      <div className={styles.photo}>
        <ImageCard imgs={tweet.media_urls} />
      </div>
